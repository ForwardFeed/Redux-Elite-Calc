...
export function calculateDPP(
  ...
  let type1Effectiveness =
    getMoveEffectiveness(gen, move, firstDefenderType, defender, attacker, isGhostRevealed, field.isGravity);
  let type2Effectiveness = secondDefenderType
    ? getMoveEffectiveness(gen, move, secondDefenderType, defender, attacker, isGhostRevealed, field.isGravity)
    : 1;
