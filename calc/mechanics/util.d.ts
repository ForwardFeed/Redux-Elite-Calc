...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, target: Pokemon, source: Pokemon, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean): number;
...
export declare function getWeightFactor(pokemon: Pokemon): 1 | 2 | 3 | 0.5;
