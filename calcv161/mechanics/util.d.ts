...
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, target: Pokemon, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean): number;
...
export declare function checkScare(gen: Generation, source: Pokemon, target: Pokemon): void;
...
export declare function colorChangeTyping(type: TypeName): "Electric" | "Normal" | "Fighting" | "Flying" | "Ground" | "Ghost" | "Steel" | "Fire" | "Water" | "Grass" | "Ice" | "Dark" | "Fairy" | "???";
